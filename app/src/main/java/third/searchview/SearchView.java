...
//    private ImageView searchBack; // 返回按键
    ...
    private ScrollView search_sv;//滚动
    ...
    private ISearchItemCallBack iSearchItemCallBack;//历史点击回调接口
    private IChangeLayout iChangeLayout;
...
//        params.height = searchBlockHeight;
        ...
        search_sv = (ScrollView) findViewById(R.id.search_sv);
...
//            tv_clear.setVisibility(GONE);
    ...
    public void setSearchItemCallBack(ISearchItemCallBack iSearchItemCallBack){
        this.iSearchItemCallBack = iSearchItemCallBack;
    }
    public void setChangeLayoutCallBack(IChangeLayout iChangeLayout){
        this.iChangeLayout = iChangeLayout;
    }
